    ...
    def chat_stream(self, user_message: str):
        ...
        if self.rag_enabled:
            ...
            if context_chunks:
                ...
                # Citations: this is decided by retrieval, not by asking the model to
                # self-report — the model can forget or misstate what it used, but we
                # already know exactly which chunks were fetched, so we surface those
                # directly to the UI instead of trusting the model's own citations.
